...
class Pizza(models.Model):
    ...
    def __str__(self):
        return f"{self.name} ||| Price: Small: ${self.small_price}  /  Large: ${self.large_price}"
...
class Dinner_Platter(models.Model):
    ...
    def __str__(self):
        return f"{self.name} (Dinner Platter)  |  Price: Small: ${self.small_price}  /  Large: ${self.large_price}"
